...
const SubmitSupplierFormDialog = ({ show, dismiss, handleSubmit }) => {
              ...
              <div className="checkbox-selection-container">
                <div role="group" aria-labelledby="checkbox-group">
                  {constants.HEB.SUPPLIER.ORDER_DAYS.map((d) => {
                    return (
                      <FormCheckbox name="orderDays" label={d} value={d} />
                    );
                  })}
                </div>
              </div>
              ...
              <div className="checkbox-selection-container">
                <div role="group" aria-labelledby="checkbox-group">
                  {constants.HEB.SUPPLIER.DELIVERY_DAYS.map((d) => {
                    return (
                      <FormCheckbox name="deliveryDays" label={d} value={d} />
                    );
                  })}
                </div>
              </div>
...
export default SubmitSupplierFormDialog;
